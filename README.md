...
- **Corner snapping:** **Snap to corners** is enabled by default for the Windows/Linux floating widget. Release the window near any corner of a screen to anchor it inside that screen's available area; it stays anchored when content, header visibility, or Full/Compact view changes its size. Drag it away from the corner or uncheck the menu option to release it.
